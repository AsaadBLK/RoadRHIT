...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'RoadRHIT') }}</title>
...
.service-40 h1, .service-40 h2, .service-40 h3, .service-40 h4, .service-40 h5, .service-40 h6 {
  color: #3e4555;
}
...
.service-40 .btn-info-gradiant {
		background: #ff6600;
    background: -webkit-linear-gradient(legacy-direction(to right), #ff6600 0%, #ff6600 100%);
    background: -webkit-gradient(linear, left top, right top, from(#ff6600), to(#ff6600));
...
.service-40 .btn-info-gradiant:hover {
		background: #ff6600;
    background: -webkit-linear-gradient(legacy-direction(to right), #ff6600 0%, #fff 100%);
    ...
    background: -o-linear-gradient(left, #ff6600 0%, #fff 100%);
...
<!-- datatable SCRIPT-->
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg" style="background-color:#606164">
  ...
  <!-- Primary Navigation Menu -->
    ...
    {{-- <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <!-- added by asaad to check if there is any content to display else make profile management ready -->
            @hasSection('header')
